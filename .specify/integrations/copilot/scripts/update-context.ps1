...
# .spec/integration.json and calls this script.
#
...
# refactored to support spec_SOURCE_ONLY (guard the Main call) before
...
# Derive repo root from script location (walks up to find .spec/)
...
& "$repoRoot/.spec/scripts/powershell/update-agent-context.ps1" -AgentType copilot
